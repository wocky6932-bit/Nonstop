...
"[project]/code (7)/app/api/orders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        console.log('[API Orders] Received order request (MySQL):', {
            formData,
            cart,
            totalPrice
        });
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createOrder"])({
            userId: userId,
            items: cart.map((item)=>({
                    id: item.id,
                    name: item.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82458f0a._.js.map