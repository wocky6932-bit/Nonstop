...
"[project]/code (7)/lib/mysql.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$node_modules$2f2e$pnpm$2f$mysql2$40$3$2e$19$2e$1_$40$types$2b$node$40$22$2e$19$2e$1$2f$node_modules$2f$mysql2$2f$promise$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code (7)/node_modules/.pnpm/mysql2@3.19.1_@types+node@22.19.1/node_modules/mysql2/promise.js [app-ssr] (ecmascript)");
;
...
// Pool de connexions
const pool = __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$node_modules$2f2e$pnpm$2f$mysql2$40$3$2e$19$2e$1_$40$types$2b$node$40$22$2e$19$2e$1$2f$node_modules$2f$mysql2$2f$promise$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createPool(dbConfig);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$lib$2f$mysql$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/code (7)/lib/mysql.ts [app-ssr] (ecmascript)");
...
async function createUser(userData) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$lib$2f$mysql$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createUser"])(userData);
        if (result.success) {
            return result;
        }
    } catch (error) {
...
async function authenticateUser(email, password) {
    try {
        // Essayer MySQL d'abord
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$lib$2f$mysql$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authenticateUser"])(email, password);
        if (result.success) {
            return result;
        }
    } catch (error) {
...
async function updateUserProfile(userId, updates) {
    try {
        // Essayer MySQL d'abord
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$lib$2f$mysql$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateUser"])(userId, updates);
        if (result.success) {
            return result;
        }
    } catch (error) {
...
async function createOrder(orderData) {
    try {
        // Essayer MySQL d'abord
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$code__$28$7$292f$lib$2f$mysql$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createOrder"])(orderData);
        if (result.success) {
            return result;
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ae781b9._.js.map